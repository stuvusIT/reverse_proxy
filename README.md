...
| reverse_proxy_ssl_protocols             | string          | `TLSv1 TLSv1.1 TLSv1.2`                          | nginx `ssl_protocols` option                                        |             N             |
| reverse_proxy_ssl_ciphers               | string          | ___see [defaults/main.yml](defaults/main.yml)___ | nginx `ssl_ciphers` option                                          |             N             |
...
| reverse_proxy_ssl_trusted_certificate   | string          |                                                  | nginx ssl_trusted_certificate option                                |             N             |
